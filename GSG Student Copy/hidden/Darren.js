...
var didmove = true;
var d;
var think_count, move_count;

function THINK(player,enemys,maplayout)
{
    //Static Variables
    this.boxwitdh=48;
    this.boxheight=34.4;
	...
	if(didmove==true)
	{
		...
		d=nextMove();
		switch(d){
			case 0: text = "have to go up!"; break;
			case 1: text = "have to go down!"; break;
			case 2: text = "have to go left!"; break;
			case 3: text = "have to go right!"; break;
		}
		// think_count++;
	}
...
function endAI(win)
{
	if (win){
		...
		var found = false;
		didmove = true;
		// alert("I thought: " + think_count + " times and moved : " + move_count + " times!");
	}
}
